...
import {CartStateContext, CartDispatchContext, removeFromCart, toggleCartPopup} from "../context/cart";
import { CheckoutDispatchContext, setCheckoutStatus} from "../context/checkout";
...
const Cart = () => {
    ...
    const handleProceedCheckout = () => {
        setCheckoutStatus(checkoutDispatch, "not-started")
    ...
    return (<Transition.Root show={isCartOpen} as={Fragment}>
            <Dialog as="div" className="fixed inset-0 overflow-hidden" onClose={() => toggleCartPopup(dispatch)}>
                                        ...
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="ml-3 h-7 flex items-center">
                                                <button
                                                    ...
                                                    onClick={() => toggleCartPopup(dispatch)}
                                                >
                                        ...
                                        <div className="mt-8">
                                            <div className="flow-root">
                                                <ul role="list" className="-my-6 divide-y divide-gray-200">
                                                    {items.map((product) => (<li key={product.id} className="py-6 flex">
                                                            <div
                                                            ...
                                                            <div className="ml-4 flex-1 flex flex-col">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="flex">
                                                                        <button
                                                                            onClick={() => removeFromCart(dispatch, product.id)}
                                                                            type="button"
